...
class CustomsTextFormField extends StatefulWidget {
  ...
  const CustomsTextFormField({
    ...
    this.onChanged,
    this.validator,
    this.borderRadius = 10.0, // Default 10 pixels
    required this.isPrefixIcon,
    this.iconpath,
    this.onSuffixIconTap,
    this.readOnly = false,
...
class _CustomsTextFormFieldState extends State<CustomsTextFormField> {
  late FocusNode _focusNode;
  bool _isFocused = false;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        ...
        showCursor: true,
        textInputAction: widget.textInputAction ?? TextInputAction.next,
        readOnly: widget.readOnly, // Use readOnly to prevent manual input
        maxLines: widget.maxline ?? 1,
        focusNode: _focusNode,
        controller: widget.controller,
        keyboardType: widget.keyboardType,
        ...
        onChanged: widget.onChanged,
        validator: widget.validator,
        onTap: widget.onTap, // Invoke onTap callback when tapped
        decoration: InputDecoration(
          border: InputBorder.none,
          labelText: widget.labelText,
          hintText: widget.hintText,
